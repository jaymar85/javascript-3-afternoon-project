...
//element = object {} within the array
...
let orderTotals = orders.map(function(element, index,  array) {
  return element = element.price + (element.price * element.tax);
});
...
//Code Here
let bobsTotal = purchases.reduce(function(acc, currentValue, index, arraySrc) {
...
//When using reduce, alway start the initialValue at 0
